...
class Board extends JComponent implements MouseMotionListener, MouseListener {
  ...
  //public static final Sound VICTORY_SOUND = new Sound("newgame.au");
//  public static final Sound BACKGROUND_SOUND = new Sound("shuffleorboogie.au");
  public static final Sound BACKGROUND_SOUND = new Sound("shuffle.mid");

  public static final Sound VICTORY_SOUND = new Sound("victory.au");
