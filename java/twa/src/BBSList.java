...
class BBSList implements ActionListener, ListSelectionListener {
  ...
  private void createWindow() {
    theFrame = new JDialog(theTWA.getFrame(), true);
    ...
    pnlBottom.setMaximumSize(new Dimension(600, 150));
    pnlBottom.setPreferredSize(new Dimension(600, 150));
    ...
    //theFrame.setIconImage(theTWA.getScreen().imgIcon);
  ...
  private void readList() {
    ...
    while(theFileTokenizer.hasMoreTokens()) {
      ...
      if (theLineTokenizer.countTokens() == NUM_TOKENS_PER_LINE) {
        ...
        try {
          ...
          tempBBS = new BBS(strTokens[0], strTokens[1], 23, "3.11");
        }
    ...
    listNames.setPreferredSize(new Dimension(600, 200));
  ...
  private void addBBS() {
    ...
    try {
      if (txtName.getText().trim().equals("")) {
        JOptionPane.showMessageDialog(theFrame, "The BBS must have a name", "Error", JOptionPane.WARNING_MESSAGE);
      } else if (txtHost.getText().trim().equals("")) {
        JOptionPane.showMessageDialog(theFrame, "The BBS must have an address", "Error", JOptionPane.WARNING_MESSAGE);
      } else if (txtVersion.getText().trim().equals("")) {
        JOptionPane.showMessageDialog(theFrame, "A Trade Wars version must be specified", "Error", JOptionPane.WARNING_MESSAGE);
      } else {
        ...
        JOptionPane.showMessageDialog(theFrame, "Port must have an integer value", "Error", JOptionPane.WARNING_MESSAGE);
    }
