 ...
 * attempted implementing B4, B5, B6, and A2, but I was not able to get them
 * working correctly so I took them out of my code before submission
 * 
 */
...
GetToken (char *TheLine, char *Str, int *Token)
{
    ...
    char            TheHOMEString[MaxLineLen];	/* to hold the value of the
						 * HOME variable */
