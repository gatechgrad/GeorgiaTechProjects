...
/*
 * These are convenience macros for testing the return values of the
 * functions used in this project. Since C does not have a true boolean
 * type, it is best to do explicit comparisons to predefined values to
...
/*
 * The PRINTF_LIKE macro is a wrapper for functions (like printf(3s))
